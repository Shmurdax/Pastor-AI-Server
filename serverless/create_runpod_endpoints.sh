...
env = {
    ...
    "MAX_NUM_BATCHED_TOKENS": os.environ.get("MAX_NUM_BATCHED_TOKENS", "32768"),
...
require_jq_python
load_local_secrets
export MODEL_NAME MAX_MODEL_LEN MAX_NUM_SEQS MAX_NUM_BATCHED_TOKENS GPU_MEMORY_UTILIZATION LORA_NAME LORA_PATH \
