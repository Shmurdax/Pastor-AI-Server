...
screen -dmS django bash -c "
  ...
  export RETRIEVAL_THRESHOLD='${RETRIEVAL_THRESHOLD:-0.45}' &&
  export RETRIEVAL_CANDIDATE_MULTIPLIER='${RETRIEVAL_CANDIDATE_MULTIPLIER:-4}' &&
  export RETRIEVAL_MAX_PER_SOURCE='${RETRIEVAL_MAX_PER_SOURCE:-2}' &&
  export RETRIEVAL_MAX_PER_BIBLE_BOOK='${RETRIEVAL_MAX_PER_BIBLE_BOOK:-1}' &&
