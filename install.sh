...
[[ -f "$REPO_ROOT/scripts/git_safe_directory.sh" ]] && cp -a "$REPO_ROOT/scripts/git_safe_directory.sh" "$WS/scripts/git_safe_directory.sh"
[[ -f "$REPO_ROOT/scripts/sync_git_channel.sh" ]] && cp -a "$REPO_ROOT/scripts/sync_git_channel.sh" "$WS/scripts/sync_git_channel.sh"
[[ -f "$REPO_ROOT/scripts/promote_to_master.sh" ]] && cp -a "$REPO_ROOT/scripts/promote_to_master.sh" "$WS/scripts/promote_to_master.sh"
[[ -f "$REPO_ROOT/scripts/pod_profile.sh" ]] && cp -a "$REPO_ROOT/scripts/pod_profile.sh" "$WS/scripts/pod_profile.sh"
[[ -f "$REPO_ROOT/scripts/isolate_dev_env.sh" ]] && cp -a "$REPO_ROOT/scripts/isolate_dev_env.sh" "$WS/scripts/isolate_dev_env.sh"
[[ -f "$REPO_ROOT/scripts/dev_pipeline.sh" ]] && cp -a "$REPO_ROOT/scripts/dev_pipeline.sh" "$WS/scripts/dev_pipeline.sh"
[[ -f "$REPO_ROOT/scripts/sync_prod_data_to_dev.sh" ]] && cp -a "$REPO_ROOT/scripts/sync_prod_data_to_dev.sh" "$WS/scripts/sync_prod_data_to_dev.sh"
[[ -f "$REPO_ROOT/scripts/deploy_steps.sh" ]] && cp -a "$REPO_ROOT/scripts/deploy_steps.sh" "$WS/scripts/deploy_steps.sh"
[[ -f "$REPO_ROOT/scripts/prod_scheduled_deploy.sh" ]] && cp -a "$REPO_ROOT/scripts/prod_scheduled_deploy.sh" "$WS/scripts/prod_scheduled_deploy.sh"
[[ -f "$REPO_ROOT/scripts/arm_prod_deploy.sh" ]] && cp -a "$REPO_ROOT/scripts/arm_prod_deploy.sh" "$WS/scripts/arm_prod_deploy.sh"
[[ -f "$REPO_ROOT/scripts/install_prod_deploy_cron.sh" ]] && cp -a "$REPO_ROOT/scripts/install_prod_deploy_cron.sh" "$WS/scripts/install_prod_deploy_cron.sh"
[[ -f "$REPO_ROOT/tokens.test.env.example" ]] && cp -a "$REPO_ROOT/tokens.test.env.example" "$WS/tokens.test.env.example"
[[ -f "$REPO_ROOT/tokens.promote.env.example" ]] && cp -a "$REPO_ROOT/tokens.promote.env.example" "$WS/tokens.promote.env.example"
