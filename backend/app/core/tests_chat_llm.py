...
class VllmUrlResolutionTests(unittest.TestCase):
    ...
    def test_chat_view_uses_get_chat_llm_not_placeholder_key(self):
        ...
        self.assertIn("pinned_docs=catalog_docs", source)
        ...
        self.assertIn("restore_note_backed_answer", source)
        self.assertIn("strip_ungrounded_spans", source)
        self.assertIn("Drop invented quotations", source)
