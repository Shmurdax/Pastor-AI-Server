...
class VllmUrlResolutionTests(unittest.TestCase):
    ...
    def test_chat_view_uses_get_chat_llm_not_placeholder_key(self):
        ...
        self.assertIn("select_reference_notes", source)
        self.assertIn("attach_supporting_scripture", source)
        self.assertIn("scripture_docs=", source)
        self.assertIn("is_bible_chunk(doc)", source)
        self.assertIn("Note coverage=", source)
        self.assertNotIn("scored_hits[:RETRIEVAL_K]", source)
        self.assertIn("preserve_order=True", source)
        self.assertNotIn("expand_search_queries", source)
        self.assertNotIn("filter_hits_by_topic", source)
        self.assertNotIn("apply_retrieval_threshold", source)
        self.assertNotIn("topic_anchor_query", source)
        ...
        self.assertNotIn("select_diverse_docs", source)
        self.assertIn("rerank_scored_hits", source)
        self.assertNotIn("pinned_docs=", source)
        self.assertNotIn("select_chat_source_chips", source)
        self.assertNotIn("def _unique_sources", source)
        self.assertNotIn("lookup_nkjv_verses", source)
        self.assertIn("retrieval_search_text", source)
        self.assertNotIn("extract_teaching_claims", source)
        self.assertNotIn("format_teaching_claims_block", source)
        self.assertNotIn("format_generation_user_prompt", source)
        self.assertNotIn("looks_like_library_pull", source)
        self.assertNotIn("restrict_docs_to_primary_source", source)
        self.assertNotIn("pin_docs_to_strong_title_matches", source)
        self.assertNotIn("LIBRARY_PULL_STEER", source)
        self.assertNotIn("FOLLOWUP_STEER", source)
        self.assertNotIn("OPENING_RECALL_STEER", source)
        self.assertNotIn("looks_like_opening_recall", source)
        self.assertNotIn("format_opening_recall_steer", source)
        self.assertNotIn("brief_social or opening_recall", source)
        self.assertNotIn("pin_query=", source)
        ...
        self.assertNotIn("verify_answer_grounding", source)
        self.assertNotIn("_rag_grounding_fallback", source)
        self.assertNotIn("_finalize_teaching_answer", source)
        self.assertNotIn("weave_into_answer", source)
        self.assertNotIn("keep_note_paraphrase_sentences", source)
        self.assertNotIn("ground_to_note_paraphrase", source)
        self.assertNotIn("notes_only_from_claims", source)
        self.assertNotIn("restore_note_backed_answer", source)
        self.assertNotIn("strip_ungrounded_spans", source)
        self.assertNotIn("strip_retrieval_meta", source)
        self.assertNotIn("_missing_required_quotes", source)
        self.assertNotIn("appending on-topic retrieved excerpts", source)
        self.assertNotIn("then append notes if needed", source)
        self.assertNotIn("skip_rewrite_repair", source)
        self.assertNotIn("compact_teaching_answer", source)
        self.assertNotIn("QUOTE_CONTINUE_STEER", source)
        self.assertNotIn("answer_missing_required_quotes", source)
        self.assertNotIn("quote_repair_token_budget", source)
        ...
        self.assertNotIn("claim_repair_steer", source)
        self.assertNotIn("repairable_claims", source)
        self.assertIn("_finish_incomplete_extra", source)
        self.assertIn("looks_like_continue_dump", source)
        self.assertNotIn("retain_title_matches", source)
        ...
        self.assertNotIn("looks_like_brief_social", source)
        self.assertNotIn("CONVERSATIONAL_STEER", source)
        self.assertNotIn("Skipping Qdrant for brief social message", source)
        self.assertNotIn("Skipping Qdrant for opening-recall", source)
        self.assertNotIn("query_in_scope", source)
        self.assertNotIn("match_library_catalog", source)
        self.assertIn(
