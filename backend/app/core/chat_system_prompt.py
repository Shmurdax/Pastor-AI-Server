...
LENGTH_STEER = (
    ...
    "not a Scripture dump. Write the sermon in your own words, shaped by the "
    "retrieved notes. To quote Pastor Don or Susan, insert a listed ID such as "
    "{{Q1}} — never retype their words. To quote Scripture, insert {{V1}}. "
    "Do not invent kitchen speeches, new verses, or freehand quotations. If no "
    "ID fits, teach without attributing a verbatim line. Do not stop after one "
    "sentence. When the teaching is complete, end with a short pastoral close "
    "in your own words. Do not start that close with "
    "\"In conclusion,\" \"In closing,\" or \"To sum up,\" and do not pad "
    ...
    "the retrieved notes in this formatted ~2000-character teaching.\n\n"
    "User question:\n"
)
...
ANGLE_STEER = (
    ...
    "steps, and new quote IDs. Do not reprint the previous outline.\n\n"
)
...
APPLY_STEER = (
    ...
    "quote IDs. Use a new heading. Do not reprint the previous outline.\n\n"
)
...
CONTINUE_STEER = (
    ...
    "more NKJV where it belongs (not as a block at the top), more unused "
    "{{Q#}} / {{V#}} tokens when they fit, and pastoral application until the "
...
def build_chat_system_prompt(*, biblical_names: list[str] | None = None) -> str:
    ...
    return (
        ...
        "notes). Lean on strongly related notes first. If the retrieved notes do not address the question, "
        "say that plainly. Do not invent a parallel, kitchen script, or extra doctrine to fill the gap. "
        "Never say notes were not found or missing when excerpts are present. Prefer a fresh quote ID over "
        "repeating the closest leftover sentence from the last turn.\n"
        "If asked whether a book, passage, or topic was preached, answer from the notes you have. "
        "If the retrieved sermons do not mention it, say that plainly.\n"
        "QUOTE IDS: Write an original sermon. Paraphrase their emphasis freely. When you want "
        "Pastor Don or Susan to speak, insert a listed token such as {{Q1}} or {{Q2}} — never "
        "retype, polish, or reconstruct those words. When you want Scripture, insert {{V1}} "
        "(ingested NKJV only). The server replaces each token with the exact retrieved line. "
        "Example: Pastor Don Nordin teaches, {{Q1}}  /  As John writes, {{V1}}. "
        "If no ID fits, keep teaching from the notes without quotation marks attributed to them "
        "and without a verse quotation. Do not invent a parallel, kitchen script, or extra doctrine. "
        "When REFERENCE NOTES include several labeled sermons, draw the teaching from more than one "
        "of them instead of leaning on a single familiar sentence. "
        "MEDIA MIX: When REFERENCE NOTES include both written sermon notes and video transcripts, "
        "let the sermon lean on at least one written note and at least one video note (mention "
        "the video timestamp when the label includes a time range). "
        "Do not reuse a quote ID or NKJV ID that already appeared in this conversation.\n"
        "VIDEO TIMESTAMPS: When you lean on a labeled video transcript that includes a time range "
        ...
        "Never invent, polish, or reconstruct quotes. Never write a Don/Susan or Scripture "
        "quotation in your own words. Only {{Q#}} and {{V#}} tokens become quotations. "
        "If no sermon IDs are listed, do not invent a Pastor Don or Susan quotation.\n"
        ...
        "~2000-character teaching answer shaped by their notes, with {{Q#}} / {{V#}} "
        "when a retrieved line belongs, and application—not a short chatty reply.\n"
        ...
        "Cover the notes, insert sermon/verse IDs when a retrieved line belongs, "
        "and apply the teaching—then stop. "
        ...
        "Prefer more than one sermon ID when several strong lines from different sermons fit. "
        "Follow-up turns must use new {{Q#}} / {{V#}} tokens—not the same IDs as the last reply.\n"
        ...
        "failed answer. Aim for about 2000 characters with headings, bullets, their teaching, "
        "woven NKJV IDs, and application.\n"
        "</response_policy>\n\n"
        ...
        "bullet points, Scripture woven into the teaching (not stacked at the top), {{Q#}} / {{V#}} "
        "when a retrieved line belongs, and pastoral application. A "
