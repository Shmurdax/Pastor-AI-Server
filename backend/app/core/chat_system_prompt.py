...
def build_chat_system_prompt(*, biblical_names: list[str] | None = None) -> str:
    ...
    return (
        ...
        "Matthew 4:9, 1 Peter 2:9, or Romans 5:8—not the Nordins. Dictionary slides, Greek word "
        "definitions, and stock proverbs such as death and taxes are not Pastor Don quotations. "
