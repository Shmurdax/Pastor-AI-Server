...
QUOTE_CONTINUE_STEER = (
    ...
    "or biblical-character dialogue as Pastor Don or Susan. Quotes must be "
...
def build_chat_system_prompt(*, biblical_names: list[str] | None = None) -> str:
    ...
    return (
        ...
        "or any other divine first-person speech. Never write he emphasizes, he teaches, or she said before a "
