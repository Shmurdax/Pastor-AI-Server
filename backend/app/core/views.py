    ...
    def post(self, request):
        ...
        try:
            ...
            system_content = (
                ...
                "Answer biblical and Christian requests fully, including essays, summaries, explanations, and "
                "long-form teaching on Scripture people, books, or events (for example Moses or Exodus). The topic "
                "decides whether you help, not whether they asked for an essay.\n"
                "Do not dive into topics that are not related to Christianity, biblical concepts, or evangelical "
                "theology. Decline when the MAIN request is clearly unrelated: non-faith creative fiction, coding "
                "or tech support, secular homework or trivia with no faith topic, recipes, travel planning, roleplay "
                "games, multi-style rewrites, or whimsical hypotheticals with no real spiritual or biblical concern.\n"
